...
//         <div className="flex ">
//           <Logout />
//         <div className="w-10 h-10 ml-6 bg-gray-400 rounded-full"></div>
//         </div>
//       </div>
...
const TeacherMainDashboard = () => {
  ...
  const handleNavigate = () => {
    navigate("/assigned-classes", {
      state: { assignedClasses: dashboardData?.assigned_classes },
    });
  };
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      {/* Navbar */}
      <div className="flex justify-between bg-blue-700 items-center p-4 shadow-md">
        <h1 className="text-xl font-bold">Teacher Dashboard</h1>
        <div className="flex items-center">
          <Logout />
          <div className="w-10 h-10 ml-4 bg-gray-400 rounded-full" />
        </div>
      </div>
      ...
      <div className="px-4 py-6">
        {activeSection === 1 && (
          <>
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-1 gap-4">
              <div
                className="bg-red-700 p-5 rounded-xl text-center cursor-pointer shadow-md hover:scale-105 transition-transform flex flex-col items-center justify-center"
                onClick={() => navigate("/feedback-parents")}
              >
                <FileText size={28} className="mb-2 text-white" />
                <span className="text-lg font-semibold">
        ...
        {activeSection === 2 && (
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div
              className="bg-indigo-700 p-5 rounded-xl text-center cursor-pointer shadow-md hover:scale-105 transition-transform flex flex-col items-center justify-center"
              onClick={() => navigate("/marksUpload")}
            >
              <List size={28} className="mb-2 text-white" />
              <span className="text-lg font-semibold">Upload Exam Marks</span>
            ...
            <div
              className="bg-teal-700 p-5 rounded-xl text-center cursor-pointer shadow-md hover:scale-105 transition-transform flex flex-col items-center justify-center"
              onClick={() => navigate("/weeklyTestMarks")}
            >
              <BookOpen size={28} className="mb-2 text-white" />
              <span className="text-lg font-semibold">Upload Weekly Test</span>
            ...
            <div
              className="bg-pink-700 p-5 rounded-xl text-center cursor-pointer shadow-md hover:scale-105 transition-transform flex flex-col items-center justify-center"
              onClick={() => navigate("/counsellorPage")}
            >
              <Users size={28} className="mb-2 text-white" />
              <span className="text-lg font-semibold">
            ...
            <div
              className="bg-green-700 p-5 rounded-xl text-center cursor-pointer shadow-md hover:scale-105 transition-transform flex flex-col items-center justify-center"
              onClick={() => navigate("/defaulter")}
            >
              <Ban size={28} className="mb-2 text-white" />
              <span className="text-lg font-semibold">Defaulter List</span>
